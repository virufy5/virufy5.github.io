      ...
      <div className="flex flex-col items-center justify-center">
        <div className="flex max-w-[1440px] flex-col items-center justify-center ">
          ...
          <Card
            ...
            CardClassProps="flex flex-col text-center items-center w-[348px] sm:w-1/2 md:w-1/3 lg:w-1/4 2xl:w-1/4 mb-4 mt-4 rounded-[20px] m-[5px] h-[350px] shadow-xl"
          />
          <Section5
