    ...
    return (
        <>
            <form className="mt-16 px-5 sm:px-10 max-w-[1280px] lg:items-center m-auto" >
                ...
                <div>
                    <label htmlFor="user_photo" className="block mb-2 text-sm font-medium text-gray-900">Upload photo</label>
                    <div className="flex items-center justify-center w-full flex-col">
                        ...
                        <div className="flex flex-col items-start w-full mt-5 mb-10">
                            <TitleText TitleSize="h4" TitleLabel="Files" TextSize="normal"TextLabel={files} ContainerTextProps="" ContainerTitleProps="" TitleClassProps="" TextClassProps=""                        
                            />
                        </div>
                    </div>
